...
namespace EssentialTools.Tests
{
    ...
    public class UnitTest2
    {
        ...
        {
            // arrange
            //  OKAY: but this is brittle and cannot determine if problem is in LinqValueCalculator
            //var discounter = new MinumumDiscountHelper();
            //var target = new LinqValueCalculator(discounter);
            //var goalTotal = products.Sum(e => e.Price);       // replacing with Moq

            // BETTER: if this fails, then the problem is in LinqValueCalculator (or in this test, of course ;)
